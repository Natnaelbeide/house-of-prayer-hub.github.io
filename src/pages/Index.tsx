      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div ref={contentRef} className="relative z-10 text-center px-4 max-w-3xl mx-auto will-change-transform">
          <div className="mb-8 animate-fade-in-up flex justify-center" style={{ animationDelay: "0.1s" }}>
            <div className="relative rounded-full bg-primary-foreground/85 backdrop-blur-sm p-1 shadow-[0_0_60px_rgba(191,140,44,0.45)] ring-[2px] ring-accent/60 animate-[glow-pulse_4s_ease-in-out_infinite]">
              <img
                src={logo}
                alt="FAPIM Logo"
          ...
          <p
            className="text-primary-foreground/90 text-xl sm:text-2xl font-body font-medium mb-10 tracking-wide animate-fade-in-up opacity-0"
